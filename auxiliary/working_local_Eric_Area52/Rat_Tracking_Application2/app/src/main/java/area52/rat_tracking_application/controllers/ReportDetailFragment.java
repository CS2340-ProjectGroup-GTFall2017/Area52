    ...
    public ReportDetailFragment() {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (getArguments().containsKey(ARG_REPORT_ID)) {
                ...
                Log.d("ReportDetailFragment", "Got reports: " + model.getRatReports().size());
        ...
        private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
            adapter = new RatReportRecyclerViewAdapter((LinkedList) Model.getInstance().getRatReports().keySet());
        ...
        public class RatReportRecyclerViewAdapter
            ...
            @Override
            public RatReportRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            /*
             ...
             */
                ...
                return new RatReportRecyclerViewAdapter.ViewHolder(view);
            }

            @Override
            public void onBindViewHolder(final RatReportRecyclerViewAdapter.ViewHolder holder, int position) {
            /*
            This is where we have to bind each data element in the list (given by position parameter)
            to an element in the view (which is one of our two TextView widgets
             */
                //start by getting the element at the correct position
                holder.mReport = mValues.get(position);
                Log.d("Adapter", "report: " + holder.mReport);
            /*
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        /*
                            ...
                            the next window
                         */
                        intent.putExtra(ReportDetailFragment.ARG_REPORT_ID, String.valueOf(holder.mReport));
            ...
            public class ViewHolder extends RecyclerView.ViewHolder {
                ...
                public RatReport mStudent;
                public RatReport mReport;

                public ViewHolder(View view) {
                    super(view);
                    mView = view;
                    mIdView = (TextView) view.findViewById(R.id.report_detail_container);
                    Log.d("Holder", mIdView.toString());
                    mContentView = (TextView) view.findViewById(R.id.report_list);
                }
